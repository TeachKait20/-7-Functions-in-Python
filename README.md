...
### Задание 6
Напишите свою функцию для работы с числами, которая содержит документацию, описывающую её работу. Она необязательно должна быть большой и выполнять много действий (2-3 достаточно), но документация, должна быть расписана подробно.
Пример функции: 
```Python
